...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/admin-go-api_api_entity.SysMenu"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/admin-go-api_api_entity.SysMenuIdDto"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "admin-go-api_api_entity.SysMenu": {
            "type": "object",
            "properties": {
                "children": {
                    "description": "子集",
        ...
        "admin-go-api_api_entity.SysMenuIdDto": {
            "type": "object",
            "properties": {
                "id": {
                    "description": "ID",
